...
class Base:
    ...
    def create(cls, **dictionary):
        """ a class inited from a dictionary of attributes
    ...
    def load_from_file(cls):
        """ a list of classes instantiated from a file of JSON strings
        Reads from `<cls.__name__>.json`
        Returns:
            file do not exist - an empty list
            or list of classes
        """
    ...
    def load_from_file_csv(cls):
        """ a list of classes from a CSV file
    ...
    def draw(list_rectangles, list_squares):
        """ Rectangles & Squares using the turtle module
